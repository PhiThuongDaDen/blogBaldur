			...
			<div class="panel-body">
				<table class="table table-bordered table-hover">
					...
					<tr>
						...
						<td>
							<a href="index.php?controller=catalog_blog/edit&id=<?php echo $value["id"];?>">Thêm</a>
							<a href="index.php?controller=catalog_blog/list&id=<?php echo $value["id"];?>&act=delete">Xóa</a>
						</td>
					</tr>
					<?php } ?>
				</table>
